  ...
  return (
    ...
    style={{ backgroundImage: `url('${service?.hero?.bgImage || "/ServiceDetails/ChimneyCapInstall/ChimneyCap.png"}')` }}>
      ...
      <div className="absolute bottom-0 right-0 w-full pointer-events-none z-9">
       ...
       <HeroTitle
          title={hero.bigText}
          className="absolute bottom-0 lg:-bottom-20 left-1/2 -translate-x-1/2 w-full z-0 pointer-events-none"
          TextclassName="text-center text-[40px] md:text-[110px] lg:text-[150px] lg:leading-[40vh] !from-gray-200/20"
        />
    </div>
  );
};
